    ...
    <div className="adminBG w-screen h-screen flex relative overflow-hidden">
          ...
          <div className="lgs:h-full lgs:w-screen flex lgs:flex-row h-full">
            ...
            >
              <div className="w-full h-full flex items-center justify-center">
                <div className="w-[45%] h-[60%] bg-white flex flex-col border-black border-[12px] rounded-[48px] z-10 overflow-hidden">
      ...
      <div
        className={
          !profileMenu
            ? "hidden"
            : "lgs:w-[500px] lgs:h-[500px] bg-white lgs:translate-x-1 w-screen h-screen absolute overflow-y-auto flex flex-col adminBorders border-4 z-10"
        }
      >
