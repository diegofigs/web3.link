...
export default function Admin() {
  ...
  return (
    <div className="adminBG w-screen h-screen flex flex-col lgs:flex-row overflow-hidden">
      <section className="adminNavBar lgs:h-full lgs:w-[2.5%] h-[6%] flex lgs:justify-items-center lgs:flex-col flex-row">
        <button>
          <Link to="/homemain">
        ...
        <button onClick={handleClickProfileMenu}>
          <UserIcon className="lgs:w-[80%] w-10 pl-2 pt-2 flex mr-auto lgs:mb-auto justify-self-end" />
        </button>

        <div className={!profileMenu ? "hidden" : "lgs:w-28 lgs:h-28 bg-white translate-y-12"}>adadawdaw</div>
      </section>
